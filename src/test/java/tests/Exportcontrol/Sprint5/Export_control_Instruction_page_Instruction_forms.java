...
import pages.Export_control_instruction_page_forms_pages;
...
public class Export_control_Instruction_page_Instruction_forms {
    ...
    @Test
    public void Export_control_Instruction_page_Instruction_forms() {
        ...
        try {
            ...
            Export_control_instruction_page_forms_pages instructionpage = new  Export_control_instruction_page_forms_pages(driver);
