...
public class PBI_241726_Initial_Review_Workflow {
    ...
    public void Initial_review_workflow() {
        try
        {
            ...
            String expectedType = JsonDataReader.get(1, "expectedType");
            ...
            Assert.assertTrue(initialReviewWorkflowPage.verifyRecordType(expectedType), "Record Type is NOT displayed as expected");
            ExtentReportListener.getExtentTest().pass("Verified Record Type '" + expectedType + "' is displayed correctly");
            ...
            Assert.assertTrue(myActionsPage.VerifyRecordIsDisplayed(recordNum), "Record Number label is NOT displayed");
            ExtentReportListener.getExtentTest().pass("Verified 'Record Number' label is displayed");
