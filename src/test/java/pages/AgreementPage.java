...
public class AgreementPage extends BasePage {
    ...
    private By agreementSpan = By.xpath("//span[text()='2025A017161']");
    private By deliverablesTab = By.xpath("//a[@href='/agreements/2025A017161/latest/deliverables']//span[text()='Deliverables']");
    private By toggleButton = By.xpath("//button[@type='button' and @aria-label='Expand/collapse' and contains(@class, 'toggle-button')]");
    private By eSignTesting03Link = By.xpath("//a[@href='/agreements/2025A017161/latest/deliverables/1113382']//span[text()='Test']");
